...
${p2}${r}
   ...
   ${mr0}${m0c}${m0c}${m0c}${m0c}${mr0}${r}   ${dce}®${r}
  ${m00}${mb0}${mbb}${mc0}${mcc}${mc0}${mcc}${m00}${r}
 ${mr0}${m00}${m00}${mbb}${m00}${mcc}${m00}${mcc}${m00}${r}
${m00}${m40}${m44}${m44}${m44}${m00}${mcc}${m00}${mcc}${m00}${r}
${m0r}${m40}${m44}${m44}${m40}${mcc}${m0c}${mcc}${mc0}${m0r}${r}
  ${m0r}${m0r}${mc0}${mcc}${mcc}${mcc}${mcc}${m00}${mrr}${mr0}${mr0}${r}
  ${mr0}${m00}${mc0}${m00}${m0e}${m0f}${mc0}${mcc}${m00}${mcc}${mcc}${m00}${r}
 ${m00}${mef}${mff}${mff}${m00}${mff}${mff}${m00}${mcc}${mcc}${m00}${m0r}${r}
 ${m0r}${m0r}${m0r}${m0r}${m0r}${m0r}${m0r}${m0r}${m0r}${m0r}${r}
EOF
